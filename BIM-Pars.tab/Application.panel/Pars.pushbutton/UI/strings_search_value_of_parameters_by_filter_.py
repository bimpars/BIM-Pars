...
#strings_search_value_of_parameter_by_filter_.py
    ...
    try:
        with open(file_path, "r") as file:
            ...
            if first_line == "english":
                ...
                return "این ابزار باید برا ی سند خانواده استفاده شود"
            elif first_line == "russian":
                return "Этот инструмент следует использовать в семейном документе."
            elif first_line == "spanish":
                return "Esta herramienta debe ser utilizada en un documento familiar."
            elif first_line == "chinese":
                return "此工具应在家庭文档中使用。"
            elif first_line == "korean":
