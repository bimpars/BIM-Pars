...
#strings_search_value_of_instance_parameters.py
    ...
    try:
        with open(file_path, "r") as file:
            ...
            if first_line == "english":
                ...
                return "Suche nach dem Wert der Instanzparameter"
            elif first_line == "farsi":
                return "جستجوی مقدار پارامترهای نمونه"
            elif first_line == "russian":
                return "Поиск значения параметров экземпляра"
            elif first_line == "spanish":
                return "Buscar el valor de los parámetros de la instancia"
            elif first_line == "chinese":
                return "搜索实例参数的值"
            elif first_line == "korean":
...
def str_12(file_path):
    try:
        with open(file_path, "r") as file:
            ...
            if first_line == "english":
                return "value of instance parameters"
            elif first_line == "deutsch":
                return "Wert der Instanzparameter"
            elif first_line == "farsi":
                return "مقدار پارامترهای نمونه"
            elif first_line == "russian":
                return "значение параметров экземпляра"
            elif first_line == "spanish":
                return "valor de los parámetros de la instancia"
            elif first_line == "chinese":
                return "实例参数的值"
            elif first_line == "korean":
                return "인스턴스 매개변수 값"
