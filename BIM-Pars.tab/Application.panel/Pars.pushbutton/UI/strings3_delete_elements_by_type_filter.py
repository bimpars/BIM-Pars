...
#strings3_delete_elements_by_type_filter.py
    ...
    try:
        with open(file_path, "r") as file:
            ...
            if first_line == "english":
                ...
                return "دسته‌بندی‌ ای با المان در سطوح انتخاب شده وجود ندارد"
            elif first_line == "russian":
    ...
    try:
        with open(file_path, "r") as file:
            ...
            if first_line == "english":
                ...
                return "فیلترینگ بر اساس سطح هیچ نوع المانی را بدون داشتن پارامتر 'سطح' شامل نمی‌شود"
            elif first_line == "russian":
